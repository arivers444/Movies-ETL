...
def ext_trans_load(wiki_data, kaggle_data, ratings_data):
    
    with open (wiki_data, mode='r') as file:
        wiki_movies_raw = json.load(file)
    
    kaggle_metadata = read.csv(kaggle_data)
    ...
    # I am assuming the Wikipedia data still contains IMDb id's.
    try:
...
ext_trans_load(wiki_data, kaggle_data, ratings_data)